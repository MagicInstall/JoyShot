...
#define CONFIG_BTDM_CTRL_BR_EDR_MAX_SYNC_CONN 3
...
#define CONFIG_BTDM_CTRL_BR_EDR_MAX_SYNC_CONN_EFF 3
...
#define CONFIG_BT_ACL_CONNECTIONS 3
...
#define CONFIG_PTHREAD_TASK_STACK_SIZE_DEFAULT 6144
