...
static uint8_t reply106050[] = {0x03, 0x8E, 0x84, 0x00, 0x12, 0x01, 0x18, 0x80, 0x01, 0x18, 0x80, 0x80, 0x90, 0x10, 0x50, 0x60, 0x00, 0x00, 0x0D, 
                            // |  button color  |    Body color   |  grip color     |  grip color     |  ?  |
                                0xE6, 0xE6, 0xE6, 0x32, 0x32, 0x32, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}; // , 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
        ...
        case 0x30: // player lights
            // if (p_data[10] == 1)
                ...
                paired = 1;
                {
                    ...
                    arg.Player_Lights.lights = reply30[14];
